    ...
    <div style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', borderRadius: '16px',
        ...
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '4px',
          ...
          fontSize: '10px', fontWeight: 700, color: '#5A5550',
        ...
        {levelPick && (
          <div style={{ marginBottom: '14px', padding: '12px', borderRadius: '12px',
            ...
            <div style={{ fontSize: '11px', fontWeight: 800, color: '#2A6B45',
              marginBottom: '8px' }}>Votre niveau de pratique</div>
  ...
  return (
    <div className="anim-fadein" style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
      ...
      <p style={{ fontSize: '13px', color: '#8B8074', marginBottom: '20px' }}>
        Vos réponses ont été envoyées au facilitateur.
      </p>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '8px', marginBottom: '16px' }}>
        {[[practiced.length,'Pratiqués','#2A6B45','#EFF7F0'],
          [known.length,'Connus','#C17B2A','#FFF4E0'],
          [unknown.length,'Inconnus','#8B8074','#F5F1EB']].map(([n,l,col,bg]) => (
      ...
      {practiced.length > 0 && (
        <div style={{ padding: '12px', borderRadius: '12px', background: '#FFFFFF',
          ...
          <div style={{ fontSize: '10px', fontWeight: 800, color: '#8B8074',
            textTransform: 'uppercase', marginBottom: '8px' }}>Ce que vous pratiquez</div>
          {practiced.map(a => (
      ...
      <p style={{ fontSize: '11px', color: '#B0A898', marginTop: '16px', lineHeight: 1.5,
        fontStyle: 'italic' }}>
        Le facilitateur va maintenant analyser les résultats et lancer une discussion approfondie sur certains outils.
      </p>
    </div>
  )
}
      ...
      {gateUsage && (
        <div style={{ margin: '0 12px 10px', padding: '8px 10px', borderRadius: '8px',
          ...
          <div style={{ fontSize: '9px', fontWeight: 800, textTransform: 'uppercase',
            letterSpacing: '.05em', color: col, marginBottom: '2px' }}>Usage · Gate {gate}</div>
              ...
              {tool.t && (
                <div style={{ padding: '8px 10px', borderRadius: '8px',
                  ...
                  <div style={{ fontSize: '9px', fontWeight: 800, color: '#2A6B45',
                    textTransform: 'uppercase', marginBottom: '3px' }}>Conseil praticien</div>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
      <div style={{ textAlign: 'center', padding: '14px', borderRadius: '12px',
        ...
        <div style={{ fontSize: '12px', color: '#8B8074', marginTop: '2px' }}>
          {['','Pas prêt','Peu prêt','En développement','Prêt','Très prêt'][value]}
        </div>
      </div>
  ...
  return (
    <div style={{ background: '#F2EDE4', minHeight: '100vh', display: 'flex',
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '18px' }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: 'Barlow Condensed, sans-serif', fontWeight: 900,
            fontSize: '14px', color: '#1C2530' }}>URBANQUEST</div>
          ...
          {answered && (
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column',
              ...
              <p style={{ color: '#8B8074', fontSize: '12px' }}>
                {revealed ? 'Le facilitateur révèle les résultats…' : 'En attente des autres…'}
              </p>
            </div>
          )}
        </div>
...
`.trimStart())
console.log('ParticipantView v2 OK')
